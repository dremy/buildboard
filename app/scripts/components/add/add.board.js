...
/**
 * @ngdoc function
 * @name bb.board.controller:addBoardCtrl
 * @description
 * # AddBoardCtrl
 * Controller of the bb.board
 */
function addBoardCtrl($state, $scope, filepickerService, relationshipService, boardService, fileService, rel, messages, alert, preloader) { 
...
angular.module('bb.board', [])
  .controller('AddBoardCtrl', addBoardCtrl);